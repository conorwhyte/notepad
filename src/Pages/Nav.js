...
Nav.propTypes = {
  ...
  showGutter: PropTypes.func.isRequired,
  searchForString: PropTypes.func.isRequired,
  changeEditorTheme: PropTypes.func.isRequired,
  changeEditorMode: PropTypes.func.isRequired,
  handleChange: PropTypes.func.isRequired,
  savePreviousValue: PropTypes.func.isRequired,
  resetNote: PropTypes.func.isRequired,
  previewMarkdown: PropTypes.func.isRequired,
  splitMarkdownEditor: PropTypes.func.isRequired,
  jsonToYaml: PropTypes.func.isRequired,
  yamlToJson: PropTypes.func.isRequired,
};